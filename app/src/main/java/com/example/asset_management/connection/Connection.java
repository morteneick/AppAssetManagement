        ...
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, retrofit2.Response<JsonObject> response) {
                ...
                if ( access == true){
                    ...
                    userInfo.setBookingDevice(rights.get("edit_device").getAsInt());
                    userInfo.setBookingDevice(rights.get("add_device").getAsInt());
                    userInfo.setBookingDevice(rights.get("delete_user").getAsInt());
                    userInfo.setBookingDevice(rights.get("edit_user").getAsInt());
                    userInfo.setBookingDevice(rights.get("delete_booking").getAsInt());
                    userInfo.setBookingDevice(rights.get("edit_booking").getAsInt());
                    userInfo.setBookingDevice(rights.get("picking").getAsInt());
